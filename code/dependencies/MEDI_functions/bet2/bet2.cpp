...
mexEvalString("drawnow;");
    ...
    char ctmp[64];
    sprintf(ctmp, "%f", fractional_threshold.default_value());
    fractional_threshold.set_value(string(ctmp));
    sprintf(ctmp, "%f", gradient_threshold.default_value());
    gradient_threshold.use_default_value();
    sprintf(ctmp, "%f", radiusarg.default_value());
    radiusarg.use_default_value();
