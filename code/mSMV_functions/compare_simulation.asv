...
true_QSM = load('data\simulation\RDF_sim_gt.mat').true_QSM+0.4*double(sss.img);
...
QSM_stats(true_QSM,QSMs,Masks,gray_mask,double(sss.img),roi_mask,matrix_size,voxel_size)
