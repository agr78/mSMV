...
N_std_resrem('data\simulation\RDF_sim.mat','data\simulation\RDF_sim_nstdresrem.mat');
...
QSM_sim_nstd = MEDI_L1('filename', 'data\simulation\RDF_sim_nstdresrem.mat','lambda',reg_lam,'dipole_filter',1);
...
sss = load_nii('sagittal_sinus.nii');
