...
static real32_T (*b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *R2s,
...
static real32_T d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *radius,
                                   const char_T *identifier);

static real32_T d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
                                   const emlrtMsgIdentifier *parentId);

static boolean_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *pf,
                                    const char_T *identifier);
                                     ...
                                     const char_T *identifier))[4849664]
{
  ...
  y = b_emlrt_marshallIn(sp, emlrtAlias(R2s), &thisId);
                                     ...
                                     const char_T *identifier))[3]
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = c_emlrt_marshallIn(sp, emlrtAlias(voxel_size), &thisId);
                                   ...
                                   const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = d_emlrt_marshallIn(sp, emlrtAlias(radius), &thisId);
                                    ...
                                    const char_T *identifier)
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = e_emlrt_marshallIn(sp, emlrtAlias(pf), &thisId);
                                 ...
                                 const char_T *identifier))[4849664]
{
  ...
  thisId.fParent = nullptr;
  thisId.bParentIsCell = false;
  y = emlrt_marshallIn(sp, emlrtAlias(RDF), &thisId);
...
void msmv_api(const mxArray *const prhs[8], const mxArray **plhs)
{
  ...
  R2s = b_emlrt_marshallIn(&st, emlrtAlias(prhs[2]), "R2s");
  voxel_size = c_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "voxel_size");
  radius = d_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "radius");
  maxk = d_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "maxk");
  vr = d_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "vr");
  pf = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[7]), "pf");
  // Invoke the target function
  msmv(*RDF, *Mask, *R2s, *voxel_size, radius, maxk, vr, pf);
...
// End of code generation (_coder_msmv_api.cpp)
