...
if background_field == 1
    ...
    filename = 'data\simulation\RDF_sim_50.mat';
else
    x = x_gt;
...
try
    ...
    warning(['ROMEO unwrapping failed with prepackaged mex file, using region-growing phase unwrapping....' ...
        ' For more details, visit: https://github.com/korbinian90/ROMEO']);
...
save(strcat(filename),'RDF','iFreq','iFreq_raw','iMag','N_std','Mask',...
