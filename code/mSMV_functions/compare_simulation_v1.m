...
[minval_VSHARP,idxmin_VSHARP] = min(cell2mat(mse_LBV));
...
msmv_direct('data\simulation\RDF_sim.mat','data\simulation\RDF_sim_dmsmv.mat')
Mask = Mask_SMV;
...
reg_lam = 100;
QSM_sim_SHARP = MEDI_L1('filename','RDF_sim_SHARP.mat','lambda',reg_lam,'dipole_filter',0); % Should be 1?
...
QSM_sim_dmsmv =  MEDI_L1('filename','RDF_sim_dmsmv.mat','lambda',reg_lam,'dipole_filter',0);
...
QSMs = {Mask_c.*QSM_ctrl 
        ...
        Mask_c.*QSM_sim_msmv};
Masks = {Mask_c Mask_c Mask_SMV Mask_SHARPs{idxmax_SHARP} Mask_RESHARPs{idxmax_RESHARP} Mask_VSHARP Mask_LBV{idxmin_LBV} Mask_iSMV Mask_c};
