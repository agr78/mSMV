...
[`SEPIA` patch](https://github.com/agr78/mSMV/tree/main/patch) <br/>
## Summary 
...
save RDF.mat RDF iFreq iFreq_raw iMag N_std Mask matrix_size voxel_size delta_TE CF B0_dir Mask_CSF R2s;

% Reconstruct QSM
QSM = MEDI_L1('filename', 'RDF.mat', 'lambda', 1000, 'merit', 'msmv', 5);
```
For use with the [`SEPIA` toolbox](https://github.com/kschan0214/sepia), apply the patch by creating a new branch
```
